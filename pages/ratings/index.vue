    ...
    <div class="c_ratings">
      <div>
        <AppText variant="16" font="600"
          >Know And Review Elected Politicians Approval Ratings!
        </AppText>
        <AppText
          class="my-3"
          variant="16"
      ...
      >
        ...
        <div class="p-2 border-y-4 border-black">
          <p>{{ item.title }}</p>
        </div>
        <div class="p-2 border-y-4 border-black">
      ...
      list: [
        {
          title: "The President",
          description:
            "H.E. Bola Ahmed Tinubu GCFR, is the 16th and current President of the Federal Republic of Nigeria.",
        ...
        },
        {
          title: "The Governors",
          description:
            "A list of the 36 state governors highlighting their achievements and performance in various sectors.",
          images: [
            "/images/png/1.png",
            "/images/png/2.png",
            "/images/png/3.png",
          ...
          count: 32,
          link: "/ratings/governors",
        },
        {
          title: "The Senate",
          description:
            "A list of the 109 senators highlighting their achievements and performance in their respective constituency.",
          images: [
            "/images/png/1.png",
            "/images/png/2.png",
            "/images/png/3.png",
        ...
        },
        {
          title: "The House",
          description:
            "A list of the 360 members of the House, highlighting their achievements and performance in their respective constituency.",
          images: [
            "/images/png/1.png",
            "/images/png/2.png",
            "/images/png/3.png",

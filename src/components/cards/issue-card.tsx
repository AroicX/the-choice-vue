...
import { MapPin, MessageCircle, Triangle } from "lucide-react";
      ...
      <CardContent>
        ...
        <div className="mt-5 flex items-center justify-between">
          <div className="flex gap-3 text-sm text-muted-foreground">
            <span className="flex items-center gap-1"><Triangle className="h-4 w-4" />{issue.upvotes}</span>
            <span className="flex items-center gap-1"><MessageCircle className="h-4 w-4" />{issue.comments}</span>
          </div>
